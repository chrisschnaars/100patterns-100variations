...
// DRAWING SETTINGS
int displayThreshold = 4; // probability of shapes being drawn
int scaleThreshold = 4; // what scale is always drawn
...
void makeCells() {
  ...
  for (int i=0; i<xCount; i++) {
    for (int j=0; j<yCount; j++) {
      ...
      cells.add(new Cell(xpos, ypos, i, j, index));
